        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    <li class="">
                        <a href="admin.php" class="nav-link text-left active" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <a href="board.php"><li class="sidebar-header">
                        Notices
                    </li></a>
                    <li class="sidebar-header">
                        Events
                    ...
                    <nav class="navbar navbar-expand navbar-light my-navbar">
                        ...
                        <form class="d-none d-sm-inline-block form-inline navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control  bg-light" style="margin:5px;" placeholder="Search for..."
                                    aria-label="Search" />
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 text-gray-800">Notice's</h1>
                                </div>
                            </div>
                            <!-- column -->
                    </div>
