                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 text-gray-800">Parking Details</h1>
                                </div>
                            </div>
                            <!-- column -->
                        </div>
                    ...
                    <div class="container">
                        <table class="table table-bordered table-hover table-light">
                            <thead>
                                <tr>
                                    <th scope="col" style="width:3%;">Flat No.</th>
                                    <th scope="col" style="width:12%;">Owner</th>                                  
                                    <th scope="col" style="width:10%;">Vehicle Type</th>
                                    <th scope="col" style="width:3%;">Slot no.</th>
                                    <th scope="col" style="width:1%;">Parking bill</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>301</td>
                                    <td>Abhijeet Jagtap</td>
                                    <td>Four Wheeler</td>
                                    <td>101</td>
                                    <td><button class="btn btn-success editbtn"><i class="fa fa-check-circle-o" style="margin-right:10px;" aria-hidden="true"></i>Paid</button></td>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>Four Wheeler</td>
                                    <td>101</td>
                                    <td><button class="btn btn-danger editbtn"><i class="fa fa-times-circle-o" style="margin-right:10px;" aria-hidden="true"></i>Not Paid</button></td>
                                    </td>
                        ...
                        <div class="container-fluid">
                            <div class="row text-muted">
                                <div class="col-6 text-left">
                                    <p class="mb-0">
                                        <a href="index.html" class="text-muted"><strong>Parking | Abhijeet Jagtap
                                            </strong></a>
                                        &copy
                                    </p>
                                </div>
