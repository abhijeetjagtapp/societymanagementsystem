                        ...
                        <table class="table table-bordered table-hover table-light">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width:10%;">Parking</th>
                                    <th scope="col" style="width:10%;">Slot no.</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                        ...
                        <div class="container-fluid">
                            <div class="row text-muted">
                                <div class="col-6 text-left">
                                    <p class="mb-0">
                                        <a href="index.html" class="text-muted"><strong>Owner Details | Abhijeet Jagtap
                                            </strong></a>
                                        &copy
                                    </p>
                                </div>
