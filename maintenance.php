                ...
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <div class="container">
                        <table class="table table-bordered table-hover table-light">
                            <thead>
                                <tr>
                                    <th scope="col" style="width:10%;">Flat No.</th>
                                    <th scope="col" style="width:12%;">Owner</th>                                  
                                    <th scope="col" style="width:12%;">Water Charges</th>
                                    <th scope="col" style="width:13%;">Electricity Charges</th>
                                    <th scope="col" style="width:10%;">Gym Charges</th>
                                    <th scope="col" style="width:10%;">Society Funds</th>
                        ...
                        <div class="container-fluid">
                            <div class="row text-muted">
                                <div class="col-6 text-left">
                                    <p class="mb-0">
                                        <a href="index.html" class="text-muted"><strong>Maintenance Details | Abhijeet Jagtap
                                            </strong></a>
                                        &copy
                                    </p>
                                </div>
