                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 text-gray-800">Society Complaints</h1>
                                </div>
                            </div>
                            <!-- column -->
                        </div>
                    ...
                    <div class="container">
                        ...
                        <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width:6%;">Flat No.</th>
                                    <th scope="col" style="width:20%;">Issue Description</th>
                                    <th scope="col" style="width:10%;">Attachment</th>
                                    <th scope="col" style="width:10%;">Status</th>
                                    <th scope="col" style="width:10%;">Updates</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>06</td>
                                    <td>301</td>
                                    <td>Staircase light not working</td>
                                    <td>Image</td>
                                    <td>New</td>
                                    <td>Not Solved</td>
                                    <td><button class="btn btn-danger editbtn"><i class="fa fa-trash-o" style="margin-right:10px;"
                        ...
                        <div class="container-fluid">
                            <div class="row text-muted">
                                <div class="col-6 text-left">
                                    <p class="mb-0">
                                        <a href="index.html" class="text-muted"><strong>Complaints | Abhijeet Jagtap
                                            </strong></a>
                                        &copy
                                    </p>
                                </div>
